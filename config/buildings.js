const BUILDINGS = {
  ...
  goldMine: {
    ...
    popMultiplier: 1.1,
    productionBase: 20,
    // 🪙 The mine is also the vault: capacity grows with its depth.
    storageBase: 3000,
    storageFactor: 1.16, // Significantly lower than wood/clay/stone
    maxLevel: 30,
    pointValue: 15,
    pointFactor: 1.25,
  ...
  arena: {
    ...
    timeMultiplier: 1.3,
    growthFactor: 0.08,
    // 🗡️ A village may keep 1 gladiator, plus 1 more for every 4 levels of
    // Arena. At the Arena's maximum of 20 that is a stable of 6.
    gladiatorBase: 1,
    gladiatorLevelsPerSlot: 4,
    baseBuildTime: 1200,
    basePop: 25,
    popMultiplier: 1.22,
    maxLevel: 20,
...
// 🩸 Signature structures join the blueprint book on the same terms.
const { RACE_BUILDINGS } = require('./races');
Object.assign(BUILDINGS, RACE_BUILDINGS);
